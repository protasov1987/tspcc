...
4. Если Stage 3 еще не закрыт, внести только минимальные добивающие изменения.
...
10. Если безопасно, воспроизведи конфликт в двух вкладках:
...
11. Открой `/archive`, `/workorders`, `/items`, `/ok`, `/oc`, если они доступны:
   - не должно быть сломанного отображения из-за миграции cards core
12. Убедись, что approvals, input control, provision и files не были “переделаны заодно”.
